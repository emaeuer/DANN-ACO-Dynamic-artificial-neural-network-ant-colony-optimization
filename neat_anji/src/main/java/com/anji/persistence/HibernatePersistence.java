...
public class HibernatePersistence implements Persistence {
    ...
    private final static Logger logger = LogManager.getLogger(HibernatePersistence.class);
    ...
    /**
     * @see com.anji.persistence.Persistence#loadChromosome(String,
    ...
    /**
     * @see com.anji.persistence.Persistence#deleteChromosome(String)
     */
    ...
    /**
     * @see com.anji.persistence.Persistence#startRun(String)
     */
