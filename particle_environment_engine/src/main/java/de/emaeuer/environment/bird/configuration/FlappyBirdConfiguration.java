...
public enum FlappyBirdConfiguration implements DefaultConfiguration<FlappyBirdConfiguration> {
    ...
    JUMP_FORCE("Magnitude of the jump force", new IntegerConfigurationValue(200, 50, 400)),
    PIPE_VELOCITY("Velocity of the pipes", new IntegerConfigurationValue(4, 1, 10)),
    GRAVITY("Magnitude of the gravity", new IntegerConfigurationValue(10, 1, 20)),
